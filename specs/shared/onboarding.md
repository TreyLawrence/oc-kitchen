...
6. **`preference_summary`** is regenerated periodically by analyzing cook log history (verdicts, notes, modifications). This is a background process, not user-facing.
